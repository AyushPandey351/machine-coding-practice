...
import com.licious.coupon.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({CouponNotFoundException.class, UserNotFoundException.class, ProductNotFoundException.class})
    public ResponseEntity<ErrorResponse> handleNotFound(RuntimeException ex) {
        return build(HttpStatus.NOT_FOUND, ex.getMessage());
    }

    @ExceptionHandler(DuplicateCouponException.class)
    public ResponseEntity<ErrorResponse> handleDuplicate(DuplicateCouponException ex) {
    ...
    public ResponseEntity<ErrorResponse> handleOptimisticLock(OptimisticLockingFailureException ex) {
        return build(HttpStatus.CONFLICT, "Coupon was modified concurrently, please retry");
    }
